...
HD_PWD='H:/Parman/networkPacket_stuffOrData/prj/DorS_git.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log stuff_or_data_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source stuff_or_data_top.tcl
