...
HD_PWD='H:/Parman/networkPacket_stuffOrData/prj/DorS_git.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stuff_or_data_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stuff_or_data_top.tcl -notrace
